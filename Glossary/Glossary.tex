...
\newglossaryentry{Project Manager}{name={Project Manager},description={(1) the person assigned by the performing organization to lead the team that is responsible for achieving the project objectives (A Guide to the Project Management Body of Knowledge (PMBOK(R) Guide) -- Sixth Edition) (2) person with overall responsibility for the management and running of a project (ISO/IEC 26514:2008 Systems and software engineering--requirements for designers and developers of user documentation, 4.39) (3) stakeholder with overall responsibility for the planning, execution, and closure of a project (ISO/IEC/IEEE 24748-5:2017 Systems and software engineering--Life cycle management--Part 5: Software development planning, 3.10) Syn: PJM}}

\newglossaryentry{analyst}{name={analyst},description={(1) member of the technical community who is skilled and trained to define problems and to analyze, develop, and express algorithms (ISO/IEC/IEEE 24765e:2015) Example: systems engineer, business analyst}}

\newglossaryentry{architect}{name={architect},description={(1) person, team, or organization responsible for systems architecture (ISO/IEC/IEEE 24765e:2015)}}

\newglossaryentry{milestone}{name={milestone},description={(1) a list identifying all project milestones and normally indicates whether the milestone is mandatory or optional (A Guide to the Project Management Body of Knowledge (PMBOK(R) Guide) -- Sixth Edition)}}